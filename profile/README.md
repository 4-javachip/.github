...
### 🐰 동섭 
- order, payment, cart 등 복잡한 도메인을 유기적으로 연결하며,  DDD와 Layered Architecture에 대한 이해도를 높일 수 있었고, 서비스 간 복잡도가 높아지며 차후 MSA 도입의 필요성을 이해할 수 있었다.
- 이번 프로젝트의 경험과 배운 점을 살려서 다음 프로젝트는 더 엄밀하고 실무적인 관점으로 진행하고 싶다.
